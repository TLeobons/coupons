...
class App extends Component {
    ...
    handleAdd = i => this.addToCart(i)

    handleRemove = i => this.removeFromCart(i)

    handleCoupon = (discount, coupon) => {
        let cart = {...this.state.cart}
        ...
        return (
            <div>
                ...
                <div className="layout-row shop-component">
                    <ProductList handleAdd={this.handleAdd} handleRemove={this.handleRemove} o products={this.state.products}/>
                    <Cart handleCoupon={this.handleCoupon} cart={this.state.cart}/>
                </div>
            </div>
        );
    }
